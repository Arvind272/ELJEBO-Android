...
public class FragmentServiceUserDetailBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.customTextViewVideoCallBtn, 5);
        sViewsWithIds.put(R.id.checkInCTV, 6);
        sViewsWithIds.put(R.id.timerCTV, 7);
        sViewsWithIds.put(R.id.timerOnIV, 8);
        sViewsWithIds.put(R.id.locateUserBT, 9);
    }
    // views
    @NonNull
    ...
    @NonNull
    public final com.eljebo.common.utils.CustomTextView customTextViewVideoCallBtn;
    @NonNull
    ...
    public FragmentServiceUserDetailBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.checkInCTV = (com.eljebo.common.utils.CustomTextView) bindings[6];
        ...
        this.customTextViewVideoCallBtn = (com.eljebo.common.utils.CustomTextView) bindings[5];
        this.locateUserBT = (com.eljebo.common.utils.CustomButton) bindings[9];
        ...
        this.timerCTV = (com.eljebo.common.utils.CustomTextView) bindings[7];
        this.timerOnIV = (android.widget.Button) bindings[8];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
