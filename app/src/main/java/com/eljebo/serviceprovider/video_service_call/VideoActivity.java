...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getServiceProviderUserId = Const.loadData(VideoActivity.this, "getServiceProviderUserId");
        loginUserId = Const.loadData(VideoActivity.this, "loginUserId");
    ...
    private void getAccessToken() {
                ...
                })
        {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("token", Const.loadData(VideoActivity.this,
                        "loginUserToken"));
                params.put("room_id", "5-6");//roomIds
                Log.e("getAccessToken==>"+"params", params.toString());
                return params;
            }
        };
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (response != null) {
                ...
                if(status.equals("0")){
                    ...
                    final iOSDialog iOSDialog = new iOSDialog(VideoActivity.this);
