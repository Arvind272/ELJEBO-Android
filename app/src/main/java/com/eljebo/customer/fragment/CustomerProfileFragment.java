                        ...
                        try {
                            ...
                            if (json.getString("status").equals("1")){
                                ...
                                if (!jsonObjData.isNull("firstname")){
                                    ...
                                    binding.nameET.setText(First_Char_Capital.capitalizeString(""+firstname));
                                }
                                ...
                                if(!jsonObjData.isNull("mobile")){
                                    ...
                                    binding.phoneNumberET.setText(""+mobile);

                                }
                                if(!jsonObjData.isNull("address")){
                                    address = jsonObjData.getString("address");
                                    binding.addressET.setText(First_Char_Capital.capitalizeString(""+address));
                                }
