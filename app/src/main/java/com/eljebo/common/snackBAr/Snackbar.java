...
public class Snackbar extends SnackbarLayout {
    ...
    private ViewGroup.MarginLayoutParams init(Context context, Activity targetActivity, ViewGroup parent, boolean usePhoneLayout) {
        ...
        if (mUsePhoneLayout) {
            ...
            layout.setMinimumWidth(res.getDimensionPixelSize(R.dimen._280dp));
            layout.setMaxWidth(
            ...
            params = createMarginLayoutParams(
                    parent, FrameLayout.LayoutParams.MATCH_PARENT, dpToPx(mType.getMaxHeight(), scale), mWidePosition);
