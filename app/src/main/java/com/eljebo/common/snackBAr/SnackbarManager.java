...
public class SnackbarManager {
    ...
    /**
     * Displays a  in the current {@link Activity}, dismissing
    ...
    public  void show() {
        try {
            show(SnackbarManager.snackBar, (Activity) SnackbarManager.snackBar.getContext());
    ...
    public static SnackbarManager create(@NonNull Snackbar snackbar) {
    ...
    /**
     * Displays a   in the specified {@link ViewGroup}, dismissing
     * the current Snackbar being displayed, if any
     *
     * @param snackbar instance of   to display
